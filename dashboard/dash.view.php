                     ...
                     <div class="col-sm my-2">
                         <div class="card border-left-primary shadow h-100 py-2" disabled>
                             <div class="card-body">
                                 ...
                                 <div class="row d-flex justify-content-center my-1 py-1">
                                     <div class="d-flex justify-content-between px-2">
                                         <a href="frm_inf_004" class="btn btn-custom mx-1"><i class="fas fa-plus"></i> Novo form </a>
                                         <a href="lista-frm" class="btn btn-outline-custom mx-1" style="border-top: 6px #026878 solid;"> <i class="fas fa-list"></i> Lista do FRM.004</a>
                                         <a href="" class="btn btn-outline-custom mx-1" style="border-top: 6px #026878 solid;"> <i class="fas fa-thumbtack"></i> Quadro de Atividades</a>
                                     </div>
                                 </div>
                                 <!-- <div class="row d-flex justify-content-center my-1 py-1">
                                    <div class="d-flex justify-content-between px-2">
