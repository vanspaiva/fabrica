...
if (isset($_POST["submit"])) {
    require_once '../db/dbh.php'; 
     ...
     $setorId = $_POST["descricao_setores"];
     ...
     $sql = "INSERT INTO frm_inf_004 (data_publicacao, data_validade, modelo, data_manutencao, descricao_setores, id_checkbox_selecionados) VALUES (?, ?, ?, ?, ?, ?)";
     ...
     mysqli_stmt_execute($stmt);
         ...
         if (!empty($executado)) {
            ...
            $sql = "INSERT INTO checkbox_selecionados (id) VALUES (?)";
